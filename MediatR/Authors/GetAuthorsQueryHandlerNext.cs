...
{
    class GetAuthorsQueryHandlerNext : IRequestHandler<GetAuthorsQueryNext, List<AuthorDTO>>
    {
        private readonly Database db;

        public GetAuthorsQueryHandlerNext(Database db)
        {
            this.db = db;
        }

        public Task<List<AuthorDTO>> Handle(GetAuthorsQueryNext query, CancellationToken token)
        {
